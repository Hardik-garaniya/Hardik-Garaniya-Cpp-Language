...
public:
    ...
    Address(string c, string sub, string s) 

        : city(c), subdistrict(sub), state(s) {}
...
int main() {
    Address stdaddress("Rajkot", "Kotda Sangani", "Gujarat");

    Student student("Hardik", "12", 2261, 85.5, stdaddress);
